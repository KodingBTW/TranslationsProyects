...
- Ninguno, informar si se encuentra al correo de contacto.

--------------------------------------------------------------------------------------------
4. INFORMACIÓN ADICIONAL
--------------------------------------------------------------------------------------------

- El juego tiene muy poco espacio gráfico, así que por el momento no es posible agregar
todos los caracteres del español, a excepción de hacer un proceso de hacking mucho mayor.
