...
### Paso 2:
Renombrar a "Battle B-Daman - Fire Spirits! (USA).gba"

### Paso 3:
Contruir el parche dando click a "build.bat"

### Paso 4:
Esperar a que termine, esto generará "Battle B-Daman - Fire Spirits! (ESP).gba"

```
TBD
```

Además se crearán 2 parches "Battle B-Daman - Fire Spirits! (ESP).bps" y
"Battle B-Daman - Fire Spirits! (ESP).ips" 
